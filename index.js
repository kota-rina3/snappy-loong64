...
function requireNative() {
  if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH) {
    ...
    if (process.arch === 'arm64') {
      try {
        return require('./snappy.android-arm64.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
        ...
        if (bindingPackageVersion !== '7.4.3' && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0') {
          throw new Error(`Native binding package version mismatch, expected 7.4.3 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`)
        }
        return binding
      } catch (e) {
        loadErrors.push(e)
    ...
    if (process.arch === 'x64') {
      try {
        return require('./snappy.freebsd-x64.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
    ...
    if (process.arch === 'x64') {
      ...
      if (isMusl()) {
        try {
          return require('./snappy.linux-loong64-musl.node')
        } catch (e) {
          loadErrors.push(e)
        }
        try {
        ...
        try {
          return require('./snappy.linux-loong64-gnu.node')
        } catch (e) {
          loadErrors.push(e)
        }
        try {
      ...
      try {
        return require('./snappy.linux-ppc64-gnu.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
    ...
    if (process.arch === 'arm64') {
      try {
        return require('./snappy.openharmony-arm64.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
      ...
      try {
        return require('./snappy.openharmony-x64.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
      ...
      try {
        return require('./snappy.openharmony-arm.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
...
if (!nativeBinding || forceWasi) {
  ...
  if (!wasiBindingLoaded && (!__napiWasiFlavorRequested || __napiWasiFlavor === "wasm32-wasi")) {
    ...
    let candidateFailed = false
    try {
      candidateError = __napiWasiResolveCandidate('@napi-rs/snappy-wasm32-wasi', true, undefined)
      candidateFailed = candidateError !== null
      if (!candidateFailed) {
        if (process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0') {
          const bindingPackageVersion = require('@napi-rs/snappy-wasm32-wasi/package.json').version
          if (bindingPackageVersion !== '7.4.3') {
            throw new Error(`WASI binding package version mismatch, expected 7.4.3 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`)
          }
        }
